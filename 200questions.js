...
const quotes = [
    ...
    "What do you wish you could tell yourself  years ago?", "What do you think you\’ll want to tell your current self  years from now?",
...
const newQuote = () => {
    ...
    document.getElementById('question').innerHTML = quotes[randomNumber];
};
